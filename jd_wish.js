...
let appNameArr = ["超级转盘"];
let appId, appName;
$.shareCode = ['T0129qsgGFsY_FzfDzVemKuV5jQJIxGbuQ','T0225KkcRksY9lSFJB-nwqZeIADzVemKuV5jQJIxGbuQ','T0205KkcNX9qqTGFVVmz1q9ODzVemKuV5jQJIxGbuQ','T0225KkcRk9N81bXdhP9wKZbJQDzVemKuV5jQJIxGbuQ','T0205KkcMkdAnD2gekm-wqJyDzVemKuV5jQJIxGbuQ','T018v_hxQBsb9VHeKBib1ADzVemKuV5jQJIxGbuQ'];
if ($.isNode()) {
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://github.com/xfchu1988/zlk/blob/main/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://github.com/xfchu1988/zlk/blob/main/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://github.com/xfchu1988/zlk/blob/main/shareCodes/wish.json')
  }

...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.fastgit.org/xfchu1988/jdxfchu/main/shareCodes/jxmc.json')
  if (!$.res) {
    $.http.get({url: 'https://raw.fastgit.org/xfchu1988/jdxfchu/main/shareCodes/jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/xfchu1988/jdxfchu@main/shareCodes/jxmc.json')
  }
  $.res = [...($.res || []), ...(await getAuthorShareCode('https://raw.fastgit.org/xfchu1988/jdxfchu/main/shareCodes/jxmc.json') || [])]

...
let shareCodes = ['ejgz5h5kcoolpxye5vectglxfa@olmijoxgmjutyscafwtqetlasq2au4ibll2tceq@rxggow4kdwppadnmbqgv4r7xfqwgh6pqwzute5y@olmijoxgmjutz6tlpbcpyts6xvdfpaq3kjlpz6y@hhirqyqtz5h3ec2a5ludievcvi3h7wlwy7o5jii@4srjlxwmo6kaol7drg5slv4u4g2obyfyxoawjvy@wsr6thb5bd25lexihg45t5kr5ydukwcgo7wl75i@nkiu2rskjyetavwjlc4h4ynzsdezzdpuo4v5ebq@4npkonnsy7xi2c3fwfur6g7lqomlrbrd7wvdh3y@4npkonnsy7xi3n32v5ypgbdxdbn2kxtzzqza2my@mh5uulbrvnknkmah5draa23rzpkswl2tqft4d4a@gkk4336xszaehfch4ghwujbgltifw67c7pi33uy@e7lhibzb3zek224md54qsd5yqsaolwepgnyh27i@4oupleiwuds2b7k4pgxpiiiksr33ycpz35c4pkq@mlrdw3aw26j3x3uwz55gnnzpz7m2hvqulvqwcpa@4npkonnsy7xi3iohmjnr2nmgkqlt2qxedhpjayi']
let allMessage = ``;
...
function readShareCode() {
    return new Promise(async resolve => {
        $.get({ url: `https://github.com/xfchu1988/zlk/blob/main/shareCodes/plant_bean.json`, timeout: 20000 }, (err, resp, data) => {
            try {
                if (err) {
                    //console.log(`${JSON.stringify(err)}`)
                    //console.log(`${$.name} API请求失败，请检查网路重试`)

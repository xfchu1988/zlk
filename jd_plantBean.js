...
let shareCodes = ['ejgz5h5kcoolpxye5vectglxfa@olmijoxgmjutyscafwtqetlasq2au4ibll2tceq@hhirqyqtz5h3ec2a5ludievcvi3h7wlwy7o5jii@4srjlxwmo6kaol7drg5slv4u4g2obyfyxoawjvy@olmijoxgmjutz6tlpbcpyts6xvdfpaq3kjlpz6y@rxggow4kdwppadnmbqgv4r7xfqwgh6pqwzute5y@h3cggkcy6agkg2mqt3v47thfo3imfpcz5cxdvfi@wsr6thb5bd25lexihg45t5kr5ydukwcgo7wl75i@nkiu2rskjyetavwjlc4h4ynzsdezzdpuo4v5ebq@4npkonnsy7xi2c3fwfur6g7lqomlrbrd7wvdh3y@4npkonnsy7xi3n32v5ypgbdxdbn2kxtzzqza2my']
let allMessage = ``;
...
function readShareCode() {
    return new Promise(async resolve => {
        $.get({ url: `https://github.com/xfchu1988/xf/blob/main/shareCodes/plant_bean.json`, timeout: 20000 }, (err, resp, data) => {
            try {
                if (err) {
                    //console.log(`${JSON.stringify(err)}`)
                    //console.log(`${$.name} API请求失败，请检查网路重试`)

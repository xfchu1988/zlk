...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://raw.fastgit.org/xfchu1988/jdxfchu/main/shareCodes/ttysq.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.fastgit.org/xfchu1988/jdxfchu/main/shareCodes/ttysq.json')
    }
    if (res) {

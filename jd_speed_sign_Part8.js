...
!(async () => {
  ...
  let lnStartAcc=Math.ceil(cookiesArr.length/9)*7;
  let lnTotalAcc=Math.ceil(cookiesArr.length/9)*8;
...
function invite2() {
  let inviterIdArr = [
    "sWiD/aUS3Y7QqYTb8hXL0S6P9VFkSh7MukncaDXxb6A=",
    "tsB1ScwjwI0bQivHb8S8NA==",
    "6j3LvEA1DoUjHxFoF8hyUA==",
    "JzoIC6Omx6JxHqAwLG06lw==",
    "dzFqCNEc3eapLUDa0d7Ot/MvAsLOYq6DDIxRTGykOg0=",
    "7cgAGSgWd5Do79zfqTl88Q==",
    "y0roFqjMY9POdXugpgQwZw=="
  ]
